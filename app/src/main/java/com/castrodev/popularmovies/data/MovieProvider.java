...
public class MovieProvider extends ContentProvider {
    ...
    /*
        ...
        match each URI to the MOVIE, MOVIE_WITH_ID, WEATHER_WITH_LOCATION_AND_DATE,
    ...
    /*
        Student: Add the ability to insert Movies to the implementation of this function.
     */
    @Override
